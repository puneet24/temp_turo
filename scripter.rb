...
res = client.search index: 'dev_car_luxury', type:'vehicles', body: {query: {match_all: {}},size: max_limit_rows}
...
res["hits"]["hits"].each do |r|
	...
	puts "*"*30
	obj = '""'
	index_res = client.index index: 'dev_car_luxury', type: 'vehicles', id: r["_id"], body: { owner: owner,make_and_model: make_and_model,year: year,description: description,price: price,owned_by: owned_by, lat: lat,long: lot,image_urls: image_urls,features: features}
	puts index_res
end